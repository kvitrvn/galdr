...
const (
	...
	PlaylistEmpty           Key = "playlist_empty"
	PlaylistHint            Key = "playlist_hint"
	PlaylistSaveTitle       Key = "playlist_save_title"
	PlaylistNamePlaceholder Key = "playlist_name_placeholder"
	PlaylistOverwrite       Key = "playlist_overwrite"
	PlaylistOverwriteHint   Key = "playlist_overwrite_hint"
	PlaylistSaveHint        Key = "playlist_save_hint"
	PlaylistTracksTitle     Key = "playlist_tracks_title"
	PlaylistTracksEmpty     Key = "playlist_tracks_empty"
	PlaylistSkippedOne      Key = "playlist_skipped_one"
	PlaylistSkippedOther    Key = "playlist_skipped_other"
	PlaylistAddNew          Key = "playlist_add_new"
	PlaylistAddChooseHint   Key = "playlist_add_choose_hint"
	PlaylistAddTitle        Key = "playlist_add_title"
	PlaylistAddHint         Key = "playlist_add_hint"
	PlaylistAddExists       Key = "playlist_add_exists"
	...
	StatusAddedQueue                 Key = "status_added_queue"
	StatusPlayNext                   Key = "status_play_next"
	StatusPlaylistListFailed         Key = "status_playlist_list_failed"
	StatusPlaylistSaveFailed         Key = "status_playlist_save_failed"
	StatusPlaylistInvalidName        Key = "status_playlist_invalid_name"
	StatusPlaylistLoadFailed         Key = "status_playlist_load_failed"
	StatusPlaylistEmptyQueue         Key = "status_playlist_empty_queue"
	StatusPlaylistSaved              Key = "status_playlist_saved"
	StatusPlaylistLoaded             Key = "status_playlist_loaded"
	StatusPlaylistLoadedSkipped      Key = "status_playlist_loaded_skipped"
	StatusPlaylistTrackAdded         Key = "status_playlist_track_added"
	StatusPlaylistTracksAdded        Key = "status_playlist_tracks_added"
	StatusPlaylistCreatedWithTrack   Key = "status_playlist_created_with_track"
	StatusPlaylistCreatedWithTracks  Key = "status_playlist_created_with_tracks"
	StatusPlaylistDestinationMissing Key = "status_playlist_destination_missing"
	StatusPlaylistTrackMissing       Key = "status_playlist_track_missing"
	StatusPlaylistTrackRemoved       Key = "status_playlist_track_removed"
	StatusPlaylistWriteFailed        Key = "status_playlist_write_failed"

	ShortcutLibrary        Key = "shortcut_library"
	ShortcutPlaylists      Key = "shortcut_playlists"
	ShortcutTracks         Key = "shortcut_tracks"
	ShortcutPlaylistTracks Key = "shortcut_playlist_tracks"
	...
	HelpQueueAdd           Key = "help_queue_add"
	HelpPlayNext           Key = "help_play_next"
	HelpAddPlaylist        Key = "help_add_playlist"
	HelpPlaylistRemove     Key = "help_playlist_remove"
	HelpPlaylists          Key = "help_playlists"
...
var keys = []Key{
	...
	Playlists, PlaylistEmpty, PlaylistHint, PlaylistSaveTitle, PlaylistNamePlaceholder,
	PlaylistOverwrite, PlaylistOverwriteHint, PlaylistSaveHint, PlaylistTracksTitle, PlaylistTracksEmpty,
	PlaylistSkippedOne, PlaylistSkippedOther, PlaylistAddNew, PlaylistAddChooseHint, PlaylistAddTitle,
	PlaylistAddHint, PlaylistAddExists,
	...
	StatusFailedDecode, StatusFailedStop, StatusPaused, StatusResumed, StatusAddedQueue, StatusPlayNext,
	StatusPlaylistListFailed, StatusPlaylistSaveFailed, StatusPlaylistInvalidName, StatusPlaylistLoadFailed, StatusPlaylistEmptyQueue,
	StatusPlaylistSaved, StatusPlaylistLoaded, StatusPlaylistLoadedSkipped, StatusPlaylistTrackAdded,
	StatusPlaylistTracksAdded, StatusPlaylistCreatedWithTrack, StatusPlaylistCreatedWithTracks,
	StatusPlaylistDestinationMissing, StatusPlaylistTrackMissing, StatusPlaylistTrackRemoved,
	StatusPlaylistWriteFailed,
	ShortcutLibrary, ShortcutPlaylists,
	ShortcutTracks, ShortcutPlaylistTracks, ShortcutQueue, ShortcutGlobal, HelpTitle, HelpNavigation,
	HelpPlayback, HelpLibrarySearch, HelpQueue,
	...
	HelpClearFilter, HelpQueueUp, HelpQueueDown, HelpQueueRemove, HelpQueueAdd, HelpPlayNext, HelpAddPlaylist,
	HelpPlaylistRemove,
	HelpPlaylists, HelpClose, HelpQuit, DiagLoadConfig,
