...
var keys = []Key{
	...
	PlaylistOverwrite, PlaylistOverwriteHint,
	...
	StatusPlaylistListFailed, StatusPlaylistSaveFailed, StatusPlaylistLoadFailed, StatusPlaylistEmptyQueue,
	StatusPlaylistSaved, StatusPlaylistLoaded, StatusPlaylistLoadedSkipped, ShortcutLibrary, ShortcutTracks,
	...
	HelpClearFilter, HelpQueueUp, HelpQueueDown, HelpQueueRemove, HelpQueueAdd, HelpPlayNext,
